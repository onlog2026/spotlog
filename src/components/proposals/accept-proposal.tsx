...
export function AcceptProposal({
  ...
  if (done) {
    return (
      <div className="text-center py-6 space-y-2">
        ...
        <h3 className="font-bold text-lg text-slate-900">Proposta aceita ✨</h3>
  ...
  return (
    <div className="space-y-4 max-w-md mx-auto">
      <h3 className="text-center font-semibold text-lg text-slate-900">Aceitar proposta</h3>
      <div className="grid sm:grid-cols-2 gap-3">
        <div className="space-y-1.5">
          <Label className="text-xs text-slate-600">Seu nome</Label>
          <Input
            value={name}
