...
const items = [
  { href: "/app/sac", label: "Dashboard", icon: LayoutDashboard, exact: true },
  { href: "/app/sac/tickets", label: "Tickets", icon: MessageSquare },
];

export function SacNav() {
  const pathname = usePathname();
  return (
    <nav
      aria-label="Navegação do SAC"
