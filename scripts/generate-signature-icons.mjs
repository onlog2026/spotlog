// Gera os ícones PNG (28x28, retina p/ exibir a 14px) usados na assinatura de
// e-mail (src/lib/email/signature.ts). Rode de novo só se quiser trocar o
// estilo dos ícones: `node scripts/generate-signature-icons.mjs`.
